...
SocialDistanceSample::SocialDistanceSample( int argc, char** argv ) :
    SampleApplication( argc, argv, "SocialDistance - Horde3D Sample", H3DRenderDevice::OpenGL2 ),
    _crowdSim(0)
{
    _x = 15; _y = 3; _z = 20;
    _rx = -10; _ry = 60;
...
bool SocialDistanceSample::initResources()
{
...
void SocialDistanceSample::releaseResources()
{
    delete _crowdSim;
    _crowdSim = 0x0;
...
void SocialDistanceSample::update()
{
